...
/* package Capital-Gains-Losses-Calculator-0.1.0.0 */
#ifndef VERSION_Capital_Gains_Losses_Calculator
#define VERSION_Capital_Gains_Losses_Calculator "0.1.0.0"
#endif /* VERSION_Capital_Gains_Losses_Calculator */
#ifndef MIN_VERSION_Capital_Gains_Losses_Calculator
#define MIN_VERSION_Capital_Gains_Losses_Calculator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Capital_Gains_Losses_Calculator */
...
#define CURRENT_COMPONENT_ID "Capital-Gains-Losses-Calculator-0.1.0.0-inplace-Capital-Gains-Losses-Calculator"
